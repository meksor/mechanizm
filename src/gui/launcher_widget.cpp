...
LauncherWidget::LauncherWidget(QWidget *parent) : QWidget(parent) {
  ...
  QObject::connect(newProjectButton.get(), &QPushButton::clicked, this,
                   &LauncherWidget::onNewProjectClicked);
  QObject::connect(openProjectButton.get(), &QPushButton::clicked, this,
                   &LauncherWidget::onOpenProjectClicked);
